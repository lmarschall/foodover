						...
						<ul class="list-group list-group-flush">
							<li class="list-group-item input-item" v-for="(ingredient, index) in ingredients" v-bind:key="ingredient">
								<div class="input-group mb-3">
									...
									<div class="input-group-append">
										<button type="button" class="close" v-on:click="deleteClicked(index)">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
								</div>
							...
							<li class="list-group-item">
								<div class="input-group mb-3">
									...
									<div class="input-group-append">
										<button class="btn btn-outline-primary rounded" v-on:click="scanClicked">
	...
	methods: {
		...
		validateInput: function (e) {
			if (e.keyCode === 13) {
				...
				this.$emit('ingredientAdded', document.getElementById('input_ingredient').value)
