...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        drop_ingredient(state, name) {
            state.search_params.ingredients =
                state.search_params.ingredients.filter((i) => i !== name);
        },
        ...
        drop_intolerance(state, name) {
            state.search_params.intolerances =
                state.search_params.intolerances.filter((i) => i !== name);
        },
