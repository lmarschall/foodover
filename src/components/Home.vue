<template>
    ...
    <div class="modal fade" id="inputModal" tabindex="-1" aria-labelledby="inputModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item input-item" v-for="(ingredient, index) in ingredients">
                <div class="input-group mb-3">
                    <input type="text" class="form-control-plaintext" v-bind:value="ingredient.name" style="border-width:0px; border:none;" readonly></input>
    ...
    <div class="accordion sticky-top" id="accordionExample">
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
            ...
            <span class="badge badge-pill badge-secondary" v-for="ingredient in ingredients"><h6>${ingredient.name}</h6></span>
    ...
    <div class="row row-cols-1 row-cols-md-2">
        <div class="col mb-4" v-for="recipe in recipes">
